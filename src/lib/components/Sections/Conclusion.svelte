...
<BodySection title="Conclusion" chapter={null}>
	<p class="mt-[-20px]">
		...
		- <em>all of these criticisms are valid</em>. In fact, Kaggle's competitions are far from
		perfect when it comes to landing jobs and teaching you everything you need to know about the
		real world. The last thing I want to do is paint a picture that Kaggle alone will solve all your
		problems.
	</p>
